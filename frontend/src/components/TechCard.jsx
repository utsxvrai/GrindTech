...
export default function TechCard({ title, description, status, level, isCurrent, accentColor = 'neon-green' }) {
  ...
  const colorMap = {
    ...
    'aqua-blue': {
      ...
      borderHover: 'hover:border-aqua-blue/60',
      shadow: 'hover:shadow-[0_0_25px_rgba(0,255,255,0.25)]',
      badge: 'bg-aqua-blue text-black',
      dot: 'bg-aqua-blue',
      dotShadow: 'shadow-[0_0_10px_2px_rgba(0,255,255,0.9)]',
      text: 'text-aqua-blue',
      textHover: 'group-hover:text-aqua-blue',
      gradient: 'from-aqua-blue/30',
      bottomLine: 'via-aqua-blue/50',
      dynamicColor: '#00FFFF'
    },
    'cpp-white': {
      border: 'border-cpp-white/30',
      borderHover: 'hover:border-cpp-white/60',
      shadow: 'hover:shadow-[0_0_25px_rgba(255,255,255,0.25)]',
      badge: 'bg-cpp-white text-black',
      dot: 'bg-cpp-white',
      dotShadow: 'shadow-[0_0_10px_2px_rgba(255,255,255,0.9)]',
      text: 'text-cpp-white',
      textHover: 'group-hover:text-cpp-white',
      gradient: 'from-cpp-white/30',
      bottomLine: 'via-cpp-white/50',
      dynamicColor: '#FFFFFF'
    },
    'python-blue': {
      border: 'border-python-blue/30',
      borderHover: 'hover:border-python-blue/60',
      shadow: 'hover:shadow-[0_0_25px_rgba(55,118,171,0.25)]',
      badge: 'bg-python-blue text-white',
      dot: 'bg-python-blue',
      dotShadow: 'shadow-[0_0_10px_2px_rgba(55,118,171,0.9)]',
      text: 'text-python-blue',
      textHover: 'group-hover:text-python-blue',
      gradient: 'from-python-blue/30',
      bottomLine: 'via-python-blue/50',
      dynamicColor: '#3776AB'
    },
    'java-orange': {
      border: 'border-java-orange/30',
      borderHover: 'hover:border-java-orange/60',
      shadow: 'hover:shadow-[0_0_25px_rgba(237,139,0,0.25)]',
      badge: 'bg-java-orange text-black',
      dot: 'bg-java-orange',
      dotShadow: 'shadow-[0_0_10px_2px_rgba(237,139,0,0.9)]',
      text: 'text-java-orange',
      textHover: 'group-hover:text-java-orange',
      gradient: 'from-java-orange/30',
      bottomLine: 'via-java-orange/50',
      dynamicColor: '#ED8B00'
    },
    'javascript-gold': {
      border: 'border-javascript-gold/30',
      borderHover: 'hover:border-javascript-gold/60',
      shadow: 'hover:shadow-[0_0_25px_rgba(247,223,30,0.25)]',
      badge: 'bg-javascript-gold text-black',
      dot: 'bg-javascript-gold',
      dotShadow: 'shadow-[0_0_10px_2px_rgba(247,223,30,0.9)]',
      text: 'text-javascript-gold',
      textHover: 'group-hover:text-javascript-gold',
      gradient: 'from-javascript-gold/30',
      bottomLine: 'via-javascript-gold/50',
      dynamicColor: '#F7DF1E'
    },
    'typescript-blue': {
      border: 'border-typescript-blue/30',
      borderHover: 'hover:border-typescript-blue/60',
      shadow: 'hover:shadow-[0_0_25px_rgba(49,120,198,0.25)]',
      badge: 'bg-typescript-blue text-white',
      dot: 'bg-typescript-blue',
      dotShadow: 'shadow-[0_0_10px_2px_rgba(49,120,198,0.9)]',
      text: 'text-typescript-blue',
      textHover: 'group-hover:text-typescript-blue',
      gradient: 'from-typescript-blue/30',
      bottomLine: 'via-typescript-blue/50',
      dynamicColor: '#3178C6'
    }
  };
