      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.04] border border-white/[0.08] mb-6">
            <span className="text-[11px] font-semibold uppercase tracking-[0.2em] text-gray-400">Testimonials</span>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="h-full p-7 rounded-2xl bg-white/[0.02] border border-white/[0.06] hover:border-white/[0.12] transition-all duration-300 flex flex-col relative overflow-hidden">
                {/* Hover glow */}
                <div
                ...
                {/* Quote icon */}
                <Quote className="w-8 h-8 text-white/[0.06] mb-4 rotate-180" />
