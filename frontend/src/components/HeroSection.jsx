...
export default function HeroSection({ onGetStarted }) {
  ...
  return (
    <section className="relative min-h-[100vh] flex items-center justify-center overflow-hidden py-20 bg-black">
          ...
          >
            ...
            >
              <motion.button
                ...
                className="px-8 py-4 bg-white rounded-full font-black text-lg text-black shadow-[0_0_20px_rgba(255,255,255,0.4)] transition-all relative overflow-hidden group"
              >
              ...
              <motion.button
                ...
                className="px-8 py-4 bg-black/40 backdrop-blur-xl rounded-full font-black text-lg text-white border border-white/10 hover:border-white/20 transition-all shadow-[0_10px_30px_rgba(0,0,0,0.5)]"
              >
                View Pricing
              </motion.button>
            </motion.div>
